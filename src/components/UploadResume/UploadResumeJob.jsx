...
const UploadResumeJob = () => {
  ...
  const fetchUploadedResumes = async () => {
    try {
      ...
      console.log("Uploaded resumes API response:", data);
      ...
      if (!currentJob || !currentJob.resumes) {
        setUploadedResumes([]);
        return;
      }

      const parsedResumes = currentJob.resumes.map((r) =>
  ...
  const handleUpload = async () => {
    ...
    try {
      ...
      // ✅ KEEP YOUR EXISTING HARD REFRESH
      setTimeout(() => {
